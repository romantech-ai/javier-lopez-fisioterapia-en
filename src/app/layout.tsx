  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="javier-lopez-fisioterapia-en";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Javier López. Fisioterapia en Badajoz"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="javier-lopez-fisioterapia-en"
          data-primary-color="#5ba559"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="javier-lopez-fisioterapia-en";
